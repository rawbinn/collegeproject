		    	...
		    	<div class="row">
		    		<div class="col-6">
		    			<div class="form-group">
				    		...
				    		<input type="text" name="name" id="name" placeholder="Value" class="form-control" required>
				    	</div>
		    		</div>
		    		<div class="col-6">
		    			<div class="form-group">
				    		<label for="city">City</label>
				    		<input type="text" name="city" id="city" placeholder="Eg: Kathmandu" class="form-control" required>
				    	</div>
		    		</div>
		    		<div class="col-6">
		    			<div class="form-group">
				    		<label for="location">Location</label>
				    		<input type="text" name="location" id="location" placeholder="Eg: Baneshwor" class="form-control" required>
				    	</div>
		    		</div>
		    		<div class="col-6">
		    			<div class="form-group">
		    		...
		    		<div class="col-6">
		    			<div class="form-group">
				    		...
				    		<input type="number" name="fee_amount" id="fee_amount" placeholder="Eg: 700000" class="form-control">
				    	</div>
		    		</div>
		    		<div class="col-6">
		    			<div class="form-group">
				    		<label for="minimim_acceptance_percentage">Minimum Acceptance Percentage</label>
				    		<input type="number" name="minimim_acceptance_percentage" id="minimim_acceptance_percentage" placeholder="Eg: 40" class="form-control">
				    	</div>
		    		</div>	
		    		<div class="col-6">
		    			<div class="form-group">
				    		<label for="name">Minimum Scholarship Percentage</label>
				    		<input type="number" name="minimum_scholarship_percentage" id="minimum_scholarship_percentage" placeholder="Eg: 40" class="form-control">
				    	</div>
		    		</div>
		    		<div class="col-6">
		    			<div class="form-group">
		    		...
		    		<div class="col-6">
		    			<div class="form-group">
				    		...
				    		<input type="number" name="pass_percent" id="pass_percent" placeholder="Eg: 50" class="form-control">
				    	</div>
		    		</div>
		    		<div class="col-6">
		    			<div class="form-group">
				    		<label for="extra_activities">No Of Extra Curriculum Activities</label>
				    		<input type="number" name="extra_activities" id="extra_activities" placeholder="Eg: 5" class="form-control">
				    	</div>
		    		</div>
		    		<div class="col-6">
		    			<div class="form-group">
				    		<label for="placements">Avg Placement (Placements/no of batch)</label>
				    		<input type="number" name="placements" id="placements" placeholder="Eg: 500" class="form-control">
				    	</div>
		    		</div>
		    		<div class="col-6">
		    			<div class="form-group">
				    		<label for="email">E-Mail Address</label>
				    		<input type="email" name="email" id="email" placeholder="Eg: contact@college.com" class="form-control">
				    	</div>
		    		</div>
		    		<div class="col-6">
		    			<div class="form-group">
